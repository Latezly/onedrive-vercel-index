...
module.exports = {
  ...
  userPrincipalName: process.env.NEXT_PUBLIC_USER_PRINCIPLE_NAME || 'share@late.moe',
  ...
  links: [
    {
      name: 'GitHub',
      link: 'https://github.com/Latezly/',
    },
    {
      name: 'Telegram',
      link: 'https://t.me/latezly',
    },
  ],
